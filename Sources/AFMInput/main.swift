...
final class AppDelegate: NSObject, NSApplicationDelegate {
    ...
    static let buildTag = "20260906-kb28"
    ...
    func applicationDidFinishLaunching(_ notification: Notification) {
        ...
        DebugLog.log("设置: 英文=\(UserPrefs.englishMode) 模糊=\(UserPrefs.fuzzyPinyin) 全角=\(UserPrefs.fullWidthPunct) FM=\(UserPrefs.fmEnhance) 词频=\(UserPrefs.userFreq)(系统设置 → 键盘 → AFM拼音)")
