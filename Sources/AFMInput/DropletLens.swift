...
enum DropletLens {
    ...
    ///   - contentShift: 内容位移(拖拽中 bar 滑动;采样坐标随之平移,水滴固定)
    static func maskShader(rect: CGRect, refraction: (h: CGFloat, amount: CGFloat),
                           layerSize: CGSize, contentShift: CGFloat) -> Shader? {
